...
- Use PhotoSync app to automatically sync photos from your phone to your computer
- Configure PhotoSync to save to a dedicated folder (e.g., ./images/new_items/)
- The app will read photos from local paths when creating listings
"""
